...
M.neorg = function ()
  ...
  legend("n", "<localleader>tc", "neorg - gtd capture" )
  legend("n", "<localleader>tv", "neorg - gtd views" )
  legend("n", "<localleader>te", "neorg - gtd edit" )
  legend("n", "<localleader>nn", "neorg - dirman new note" )
