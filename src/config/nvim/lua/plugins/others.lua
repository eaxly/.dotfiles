...
M.true_zen = function()
    ...
    Mapper.map("n", "<leader>Za", "<cmd>TZAtaraxis<cr>", { noremap = true }, "Zen","zen_ataraxis", "Enable Ataraxis mode" )
    Mapper.map("n", "<leader>Zm", "<cmd>TZMinimalist<cr>", { noremap = true }, "Zen","zen_minimalist", "Enable Minimalist mode" )
