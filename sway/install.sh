...
pkgs="sway kanshi swayidle grim slurp jq wl-clipboard waybar mako discord playerctl python-gobject neovim neofetch kitty starship zsh task sddm ripgrep imagemagick"
